...
[The runnable probe](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/experiments/device-keystore/README.md) tests a real pinned
...
A subsequent [worker password archive proof](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/experiments/device-keystore/PASSWORD-WORKER.md)
...
The [authenticated session-record experiment](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/experiments/device-keystore/SESSION-RECORDS.md)
uses a standard password capsule for a library-generated symmetric root and
...
The [native encrypted persistence driver](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/experiments/device-keystore/NATIVE-VAULT.md)
