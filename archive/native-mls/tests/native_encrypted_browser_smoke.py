...
def main():
    ...
    if args.welcome_ceremony:
        from native_welcome_ceremony_checks import compiled_assets
        successor_compiled=compiled_assets(root,args.bundle,assets,proof,work)
    ...
    class Proxy(BaseHTTPRequestHandler):
        ...
        def forward(self):
            ...
            if (args.candidate_ceremony or args.peer_ceremony) and self.command=='POST':candidate_hooks['posts']+=1
            ...
            try:
                ...
                if (args.exchange or args.welcome_ceremony) and self.path.endswith('/handshake'):
    ...
    try:
        ...
        if args.peer_ceremony:
            ...
            route_checks(proxy.server_port,cookies,successor_compiled,proof)
        if args.welcome_ceremony:
            from native_welcome_ceremony_checks import route_checks
            route_checks(proxy.server_port,cookies,successor_compiled,proof)
        elif args.custody_ceremony:
        ...
        with sync_playwright() as pw:
            ...
            if args.custody_order:
                ...
                return
            if args.peer_ceremony:
                from native_peer_ceremony_checks import run
