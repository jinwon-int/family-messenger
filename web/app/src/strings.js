...
export const strings = {
  ...
  rooms: {
    ...
    orderEditIcon: '↕',
    orderEdit: '순서',
    orderEditLabel: '대화 순서 편집',
    orderDone: '완료',
    orderDoneLabel: '대화 순서 편집 완료',
    orderHint: '▲▼로 순서를 바꾸세요(PC는 끌어서 옮기기도 됩니다). 내 다른 기기에도 같은 순서가 적용됩니다.',
  ...
  notifications: {
    title: '알림',
    intro: '앱을 닫아도 새 메시지가 오면 알려줍니다. 내용은 기기에서만 열리므로 알림에는 보낸 사람과 방 이름만 보일 수 있습니다.',
    enable: '알림 켜기',
    disable: '알림 끄기',
    on: '이 기기에서 알림이 켜져 있습니다.',
    off: '이 기기에서는 알림이 꺼져 있습니다.',
    working: '처리 중…',
    enableFailed: '알림을 켜지 못했습니다. 잠시 뒤 다시 시도해 주세요.',
    permissionRefused: '브라우저에서 알림을 허용하지 않아 켜지 못했습니다.',
    disableFailed: '알림을 끄지 못했습니다. 잠시 뒤 다시 시도해 주세요.',
    denied: '브라우저가 이 사이트의 알림을 차단해 두었습니다. 주소창의 자물쇠(또는 설정 → 사이트 권한)에서 알림을 "허용"으로 바꾼 뒤 다시 시도해 주세요.',
    deniedIos: 'iPhone·iPad 설정 → 알림 → 패밀리챗에서 "알림 허용"을 켜 주세요. 홈화면 앱에는 주소창이 없어 앱 안에서는 바꿀 수 없습니다.',
    unsupported: '이 브라우저는 웹 알림을 지원하지 않습니다. 카카오톡·라인 등에서 링크를 눌러 들어왔다면, 오른쪽 위 메뉴의 "다른 브라우저로 열기"로 Chrome이나 Safari에서 다시 열어 주세요.',
    notConfigured: '이 설치본에는 알림 서버가 설정되어 있지 않습니다.',
    iosTitle: 'iPhone·iPad에서 알림 받기',
    iosSteps: 'Safari 탭에서는 알림이 오지 않습니다. 공유 버튼(□↑) → "홈 화면에 추가"를 눌러 앱을 설치한 뒤, 홈화면 아이콘으로 열어 주세요.',
    iosOrder: '⚠ 순서가 중요합니다. 홈화면에 추가한 뒤 그 앱에서 로그인해야 합니다. Safari 탭에서 로그인한 세션과 암호화 키는 홈화면 앱으로 넘어가지 않습니다.',
  },
  account: {
    logout: '로그아웃',
