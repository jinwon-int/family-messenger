...
built [encrypted test UI](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/ENCRYPTED-UI.md) are available; neither is human-use
...
> [`archive/native-mls/`](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/README.md). Schema migrations 3..12
...
The signed synthetic [MLS delivery boundary](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/MLS-TRANSPORT.md) now provides
...
The separately selected [compiled custody UI](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/VAULT-UI.md) embeds password-unlocked
synthetic encrypted storage at `/vault/`; human-use rollout remains gated.

The [two-device preparation boundary](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/PREPARATION.md) adds an explicitly protected
...
The separate [compiled aggregate history profile](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/AGGREGATE-HISTORY-UI.md)
...
[Successor reservations](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/SUCCESSOR-RESERVATION.md) now allocate an immutable,
...
[Paired successor custody declarations](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/SUCCESSOR-CUSTODY.md) add per-role
...
paired private-client orchestration is described in [CLIENT-CUSTODY.md](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/CLIENT-CUSTODY.md); activation and exact-package Welcome/ack remain.
...
are documented in [CLIENT-CUSTODY.md](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/CLIENT-CUSTODY.md). It does not activate a
successor or change production deployment.

The [restricted successor handshake relay](https://github.com/jinwon-int/family-messenger/blob/archive-frozen-20260917/archive/native-mls/server/SUCCESSOR-HANDSHAKE.md) adds ordered
