...
//go:embed confirmation_bundle.json
var confirmationManifest []byte
var compiledConfirmationAssets fs.FS
...
func loadAssetProfile(source fs.FS, manifest []byte, paths map[string]string, version int) (*EncryptedAssets, error) {
	...
	for _, entry := range spec.Files {
		...
		switch entry.File {
		case "chat.html", "vault-chat.html", "history.html", "aggregate-chat.html", "aggregate-history.html", "successor.html", "successor-handoff.html", "candidate-preparation.html", "peer-preparation.html", "custody-ceremony.html", "welcome-ceremony.html", "confirmation-ceremony.html":
			kind = "text/html; charset=utf-8"
		case "chat.css", "history.css", "aggregate-history.css", "successor-ui.css", "candidate-preparation.css", "peer-preparation.css", "custody-ceremony.css", "welcome-ceremony.css", "confirmation-ceremony.css":
...
func NewEncryptedAccessHandler(store *Store, authority *access.Authority, bundle *EncryptedAssets, admission *AdmissionAuthority) (http.Handler, error) {
	if bundle == nil || (bundle.version != 1 && bundle.version != 2 && bundle.version != 5 && bundle.version != 4 && bundle.version != 6 && bundle.version != 7 && bundle.version != 8 && bundle.version != 9 && bundle.version != 10 && bundle.version != 11 && bundle.version != 12) || (bundle.version == 1 && len(bundle.files) != len(encryptedPaths)) || (bundle.version == 2 && len(bundle.files) != len(vaultPaths)) || (bundle.version == 5 && len(bundle.files) != len(historyPaths)) || (bundle.version == 4 && len(bundle.files) != len(aggregatePaths)) || (bundle.version == 6 && len(bundle.files) != len(aggregateHistoryPaths)) || (bundle.version == 7 && len(bundle.files) != len(successorPaths)) || (bundle.version == 8 && len(bundle.files) != len(candidatePaths)) || (bundle.version == 9 && len(bundle.files) != len(peerPaths)) || (bundle.version == 10 && len(bundle.files) != len(custodyPaths)) || (bundle.version == 11 && len(bundle.files) != len(welcomePaths)) || (bundle.version == 12 && len(bundle.files) != len(confirmationPaths)) {
		return nil, ErrInvalid
	}
