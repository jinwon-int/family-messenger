...
func TestMLSSchemaSnapshotRestartPreservesLegacy(t *testing.T) {
	...
	_, e = db.Exec("DROP TABLE mls_successor_confirmation; DROP TABLE mls_successor_handshake; DROP TABLE mls_successor_custody; DROP TABLE mls_successor_reservations; DROP TABLE mls_preparations; DROP TABLE mls_events; DROP TABLE mls_rooms; PRAGMA user_version=2")
	db.Close()
	if e != nil {
		t.Fatal(e)
	}
