...
func Open(dir string) (_ *Store, err error) {
	...
	if e == nil {
		...
		if statErr != nil {
			...
			if e == nil && (string(header[:16]) != "SQLite format 3\x00" || binary.BigEndian.Uint32(header[68:72]) != 1179471188 || (binary.BigEndian.Uint32(header[60:64]) != 1 && binary.BigEndian.Uint32(header[60:64]) != 2 && binary.BigEndian.Uint32(header[60:64]) != 3 && binary.BigEndian.Uint32(header[60:64]) != 4 && binary.BigEndian.Uint32(header[60:64]) != 5)) {
	...
	if ((version == 1 || version == 2 || version == 3 || version == 4 || version == 5) && appID != 1179471188) || (version == 0 && appID != 0) {
